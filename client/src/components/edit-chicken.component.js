...
export default class EditChicken extends Component{
  ...
  handleSubmit(event){
    ...
    axios.post(`http://localhost:5000/chicken/update/`+this.props.add.match.params.id, chickenData)
...
<div className="form-components">
  <h3 className="calculator-title">Edit Chicken!</h3>
        <form onsubmit="return false;">
          ...
          <select ref="userInput" className="form-control"name="user" required value={this.state.username} onChange={this.onChangeUsername} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
            {
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    ...
                    <input name="tag" onChange={this.onChangeTag} value={this.state.tag}type="text" id="tag" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="0000" required=""/>
                </div>
                <div>
                    <label htmlFor="type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Type</label>
                    <input name="type" onChange={this.onChangeType} value={this.state.type}type="text" id="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Darag Chicken" required=""/>
                </div>
                <div>
              ...
              <button type="button" onClick={this.handleSubmit} calue="Edit Chicken" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Submit</button>
            </div>
        </form>
